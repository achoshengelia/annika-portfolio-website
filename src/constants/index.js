...
export const indexItems = [
  ...
  },
  {
    id: createID(),
    caption: 'Extrasober',
    tags: 'Curation | Co-Management',
    organisation: 'Forum Prävention',
  ...
  {
    id: createID(),
    caption: 'Zueinander (finden) - trovarsi',
    tags: 'Concept | Webdesign | Product design',
    organisation: 'Verband Ariadne',
    projectlink:
  ...
  },
  {
    id: createID(),
    caption: 'Forecast',
    tags: 'Video sculpture | Shader-animation',
    organisation: '',
    projectlink: '',
    year: '2019',
    image:
  ...
  },
  {
    ...
    tags: 'Curation | Exhibition design',
    organisation: 'designtransfer',
    projectlink:
  ...
  },
  {
    id: createID(),
    caption: 'Datadust 2',
    tags: 'Physical data visualisation',
    organisation: '',
    projectlink: '',
    year: '2019',
    image:
